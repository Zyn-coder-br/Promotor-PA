...
window.PromotorSupabase={
 ...
 async signUp({email,password,full_name,company}){const c=await getClient();const r=await c.auth.signUp({email,password,options:{data:{full_name,company}}});if(r.error)throw r.error;return r.data;},
